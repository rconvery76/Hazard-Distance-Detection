...
This directory contains a test input and output as well as pinhole.py
...
To run the entire pinhole model with object detection pipeline run
    
    - python object_detect_orthophoto.py
